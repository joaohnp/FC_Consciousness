...
from curbd_analysis.analysis.simdata_utils import get_configs, get_neurons, psth_to_area
from curbd_analysis.analysis.curbd import computeCURBD, trainMultiRegionRNN
...
for i in range(0, TOTAL_SIMULATION):
    ...
    base = resolve_path("src", "curbd_analysis", "data", "simdata", "spike_data")
...
save_figure(fig, f"analysis/baseline_raincloud+{str(picked_size)}+")
